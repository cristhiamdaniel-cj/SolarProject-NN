...
def main():
    ...
    json_file = 'extraccion/panelData_part_1.json'
    processed_file = 'extraccion/processed_models_1.txt'
    ...
    header = not os.path.exists('extraccion/panel_simulation_data_1.csv')
