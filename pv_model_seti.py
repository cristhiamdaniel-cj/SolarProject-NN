...
logging.basicConfig(filename='simulation_3.log', level=logging.DEBUG, format='%(asctime)s - %(levelname)s - %(message)s')
...
def main():
    ...
    json_file = 'missing_panels_data_3.json'
    ...
    models_to_process = unprocessed_models[:479]
